> Historical development notes, primarily in Italian. Entries describe the state at their date and may be superseded. For current work, see [the roadmap](roadmap.md).
