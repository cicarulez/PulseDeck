...
Speaking is an explicit voice event, not the inverse of mute/deaf. Gaming highlights speakers only when the voice connection is available. The header hides the tracked member when absent from the connected roster.
